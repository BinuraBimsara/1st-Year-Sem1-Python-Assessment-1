...
def add_task():
    ...
    task = {                 #Stores all the user data
        "name": task_name.lower(),  #lower() used to convert the task name to lowercase so that the task name can be case insensitive
...
def update_task():
    ...
    for task in tasks:
        if task["name".lower()] == task_name.lower():   #to check if the task name exists and displays it to the user for updating
            print("\nTask Found")
            print(f"\nTask name   : {task['name'.lower()]}")
            print(f"Description : {task['description']}")
            print(f"Priority    : {task['priority']}")
...
def delete_task():
    ...
    for task in tasks:
        if task["name".lower()] == task_name.lower():   #checks if the task exists
            print("\nTask found \n")
            print(f"\nTask name   : {task['name'.lower()]}")
            print(f"Description : {task["description"]}")
            print(f"Priority    : {task["priority"]}")
